  ...
  return (
    <>
      <style>{`
        ...
        @media(max-width:900px){.uhero-grid{grid-template-columns:1fr}.uhero-grid h1{font-size:31px}.ustats{gap:22px}}
      `}</style>
      ...
      <section className="sec" style={{ paddingTop: 0 }}><div className="wrap" style={{ maxWidth: 920, margin: '0 auto' }}>
        ...
        <p style={{ color: 'var(--mut2)', fontSize: 12.5, marginTop: 12 }}>Fiyatlar ve tarihler 2026 sezonu içindir ve sağlayıcıya göre değişebilir; kesin tutar için danışmanlık al. Şehir görselleri: Wikimedia Commons.</p>
      </div></section>
